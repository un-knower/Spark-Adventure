...
object IpStatisticsByProvince {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val log = sc.textFile("sparkcore\\sparkcdn\\src\\main\\resources\\access.log").cache()
    val ipLocation = sc.textFile("sparkcore\\sparkcdn\\src\\main\\resources\\ip.txt").cache()
