...
class RpcWorker(val masterHost: String, val masterPort: Int, val memory: Int, val cores: Int) extends Actor{
...
object RpcWorker {
  def main(args: Array[String]) {
    ...
    val workerActorRef = actorSystem.actorOf(Props(new RpcWorker(masterHost, masterPort, memory, cores)), "Worker")
